...
void loop() {
  ...
  interface(Serial,
    ...
    write_register_multiple, "write_register_multiple: Write to multiple PN5180 registers. @elements: Vector of up to 42 objects (address, operation, value/mask). Operation: 1=Write, 2=OR mask, 3=AND mask. @return: 0 at success, < 0 at failure.",
